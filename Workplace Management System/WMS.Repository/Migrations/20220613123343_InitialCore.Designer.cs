...
namespace WMS.Repository.Migrations
{
    ...
    [Migration("20220613123343_InitialCore")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Data.Entity.Core.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WMS.Data.Entity.Core.Floor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WMS.Data.Entity.Core.Reservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WMS.Data.Entity.Core.Site", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WMS.Data.Entity.Core.Workplace", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WMS.Data.Entity.Core.Floor", b =>
                {
                    b.HasOne("WMS.Data.Entity.Core.Site", "Site")
                        .WithMany("Floors")
            ...
            modelBuilder.Entity("WMS.Data.Entity.Core.Reservation", b =>
                {
                    b.HasOne("WMS.Data.Entity.Core.Employee", "Employee")
                        .WithMany("Reservations")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WMS.Data.Entity.Core.Workplace", "Workplace")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("WMS.Data.Entity.Core.Workplace", b =>
                {
                    b.HasOne("WMS.Data.Entity.Core.Floor", "Floor")
                        .WithMany("Workplaces")
